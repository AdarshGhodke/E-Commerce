    ...
    <div>
        <div className='flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 mt-40 text-sm'>
            ...
            <div>
                ...
                <ul className='flex flex-col gap-1 text-gray-600'>
                    <li>+91-7736-27373</li>
                    <li>contact.Vit_shop@info.com</li>
                </ul>
            </div>
        </div>
        <div>
            <hr />
            <p className='py-5 text-sm text-center'>Copyright 2024 Vit_shop. All rights reserved.</p>
        </div>
    </div>
  )
}
